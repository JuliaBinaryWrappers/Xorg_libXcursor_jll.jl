...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXcursor_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("935fb764-8cf2-53bf-bb30-45bb1f8bf724"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXcursor; unsupported platform $(triplet(platform_key_abi()))")
else
